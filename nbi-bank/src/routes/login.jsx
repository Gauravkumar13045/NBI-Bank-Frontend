                ...
                <div className="flex flex-col items-center justify-center w-full md:w-1/2 py-6">
                    ...
                    <div className=" backdrop-blur-xl border border-white/10 rounded-2xl p-8 w-full mt-5 md:m-0 max-w-md mx-4 text-center" style={{
                        ...
                        <div className="text-left mt-5">
                            <div>
                                <label className="text-white text-sm ">Email Address or Mobile number</label><br></br>

                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-mail text-[#D3D3D2] w-7 absolute mt-3.5 ml-3"> <path stroke="none" d="M0 0h24v24H0z" fill="none" /> <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10" /> <path d="M3 7l9 6l9 -6" /></svg>
                                    <input type="text" placeholder="Email address or Mobile number" className=" mt-1 rounded-lg border-2 border-[#313030] text-gray-300 p-2.5 pl-12 w-full placeholder:text-sm "></input>

                                </div>
                            </div>

                            <div className="mt-3">
                                <label className="text-white text-sm">Password</label><br></br>

                                <div className="flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-lock text-[#D3D3D2] w-7 absolute mt-3.5 ml-3"> <path stroke="none" d="M0 0h24v24H0z" fill="none" /> <path d="M5 13a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-6" /> <path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0" /> <path d="M8 11v-4a4 4 0 1 1 8 0v4" /></svg>
                                    <input type="password" className=" mt-1 rounded-lg border-2 border-[#313030] text-gray-300 p-2.5 w-full pl-12 placeholder:text-sm" placeholder="Password" ></input>
